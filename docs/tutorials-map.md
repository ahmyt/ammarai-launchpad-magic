...
All published reference-interface screenshots that display a far-right account avatar now replace that avatar with the AmmarAI logo. Native dimensions and all instructional controls remain unchanged.
