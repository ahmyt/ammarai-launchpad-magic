# Swap AI Social Media Agent and AI SEO Analyzer on the homepage
...
- Preserve the secondary carousel’s numbering, autoplay, arrows, indicators, touch behavior, card design, and total of 18 tools.

## “How the workspace works” section

- Replace the AI SEO Analyzer workflow card with an AI Social Media Agent workflow card.
- Describe its real flow: provide business/channel context and campaign goals; AmmarAI plans, creates, schedules, and publishes social posts with optional approval; the result is a coordinated channel-ready content schedule.
- Keep the section’s current layout, card count, ordering system, and related use-case links.
