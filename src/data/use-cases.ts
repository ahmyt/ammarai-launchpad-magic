...
export const useCases: UseCase[] = [
  ...
  },
  {
    ...
    description: "AmmarAI helps small business owners write website copy, ads, and customer emails themselves, without hiring an agency or a full-time marketer. Start free today.",
  ...
  },
  {
    ...
    description: "AmmarAI helps founders write pitch copy, landing pages, and outreach emails fast, so a new idea can be tested before it goes cold. Try it free in AmmarAI.",
  ...
  },
  {
    ...
    description: "AmmarAI helps students summarize readings, brainstorm essay ideas, and check grammar, as a study aid, not a way to skip doing the work. Try it free in AmmarAI.",
  ...
  },
  {
    ...
    description: "AmmarAI helps developers generate boilerplate code, write documentation, and draft technical content without breaking flow to switch tools. Start free today.",
  ...
  },
  {
    ...
    description: "AmmarAI helps agencies produce client deliverables across multiple accounts at once, so growth doesn't mean hiring at the same pace as new business. Start free.",
  ...
  },
  {
    ...
    description: "AmmarAI helps e-commerce sellers write product descriptions, titles, and ad copy across a full catalog, without a copywriter per SKU. Try it free in AmmarAI.",
  ...
  },
  {
    ...
    description: "AmmarAI helps social media managers draft captions, hashtags, and post ideas across platforms, so the calendar doesn't run empty mid-month. Start free today.",
  ...
  },
  {
    ...
    description: "AmmarAI helps SEO professionals produce optimized blog content, meta descriptions, and FAQ sections at the volume organic growth actually requires. Free to try.",
  ...
  },
  {
    ...
    description: "AmmarAI helps busy professionals draft emails, summarize documents, and write routine communications faster, clearing the small tasks that pile up. Free to try.",
